            ...
            <div class="col m6 s12">
                <div class="card panel no-padding">
                    ...
                    <div class="card-content">
                        ...
                        <div class="clearfix"></div>
                        <a href="javascript:;" onclick="javascript:$('#frmAddOrganization').submit();" class="btn blue waves-effect waves-light s12 m3 l3 text-white"><i class="tiny material-icons">done</i><?php echo lang('org_btn_save_organization'); ?></a>
