        ...
        <div class="container">
            <div class="nav-wrapper">
                ...
                <ul id="nav-dashboard" class="right hide-on-med-and-down">
                    ...
                    <li><a href="<?php echo base_url('admin/faq'); ?>"><i class="tiny material-icons">help</i><span><?php echo lang('menu-faq'); ?></span></a></li>
                ...
                <ul id="mobile-demo" class="side-nav">
                    ...
                    <li><a href="<?php echo base_url('admin/faq'); ?>"><i class="tiny material-icons">help</i><span><?php echo lang('menu-faq'); ?></a></span></li>
