        ...
        <div class="container">
            <div class="nav-wrapper">
                ...
                <ul id="nav-dashboard" class="right hide-on-med-and-down">
                    ...
                    <li><a href="<?php echo base_url('panel/help'); ?>" class="waves-light waves-effect p-r-5 p-l-5"><i class="tiny material-icons">help</i></a></li>
                ...
                <ul id="mobile-demo" class="side-nav">
                    ...
                    <li><a href="<?php echo base_url('panel/help'); ?>"><i class="tiny material-icons">help</i></a></li>
