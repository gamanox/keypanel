<div id="history" class="card small partial">
    <div class="card-content">
        <p class="card-title blue-grey-text text-darken-4"><i class="tiny material-icons">history</i>&nbsp;&nbsp;<?php echo lang('card-historial-title'); ?><a href="<?php echo base_url('panel'); ?>" class="waves-effect waves-blue btn-flat close"><i class="tiny material-icons valign">close</i></a></p>
        <?php
